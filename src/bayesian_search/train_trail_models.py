...
def train_models(log_filepath, study_filepath, save_dir):

    extract_information_from_trials(study_filepath, log_file=log_filepath, order_by='value')
    ...
    for idx, trial in enumerate(filtered_trials):
        ...
        checkpoint_callback = pl.callbacks.ModelCheckpoint(
            dirpath=f"{save_dir}/trial_{trial['Trial']}", 
